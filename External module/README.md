...
3. sfruttare il fatto che l'esp32 è già predisposto per l'alimentazione via batteria e quindi forse anche per poter leggere il voltaggio della batteria usando un pin analogico senza ulteriori resistenze https://github.com/HelTecAutomation/Heltec_ESP32/blob/master/examples/ESP32/ADC_Read_Voltage/Battery_power/Battery_power.ino e https://github.com/3KUdelta/heltec_wifi_kit_32_batt_monitor/blob/master/Wifi_Kit_32_Batt_Watch.ino.
